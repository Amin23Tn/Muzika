...
public class FragmentProfile extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getUserInfo(sharedPreferences.getString("LOGIN",""),progressDialog,sharedPreferences.getString("USERNAME",""));
    ...
    public void getUserInfo(String token,ProgressDialog progressDialog,String username) {
        SessionManager sessionManager = new SessionManager(getContext());

        user usr = AppDataBase.getAppDatabase(getContext()).userDao().findbyusername(username);
        ...
        RequestHeaders requestHeaders = new RequestHeaders();
            requestHeaders.put("Authorization", "Bearer " + "BQCDWAkLGfNqjiyCEVJmMyVt49XTZZ7U9aGvUAZOsHitkv60yCNrvp_06vs_BTBgkmzwjnvlVaLxKpmxZo-N2RRkuJpAA0T1BcpRh5DQP2_jwd4g7eeW9xT4SdnZqFFVCo2bOt6mS62BsHaRMDKV_1DkJlpqn98");
        ...
        client.get("https://api.spotify.com/v1/me", requestHeaders, null
                , new JsonHttpResponseHandler() {
                    ...
                    public void onFailure(int statusCode, @Nullable Headers headers, String errorResponse, @Nullable Throwable throwable) {
                        ...
                        profileName.setText(usr.getUsername());
